...
; https://code.google.com/p/hessian/

                processor 6502

        ; Constant definitions

NUMSPR          = 24            ;Number of sprites used by the main program
MAXSPR          = 24            ;Maximum number of supported sprites

MINSPRY         = 30            ;Minimum visible sprite Y-coordinate
MAXSPRY         = 250           ;Maximum visible sprite Y-coordinate + 1

IRQ1LINE        = $10           ;IRQ at the top of screen
...
sprorder        = $40+MAXSPR+1  ;& sorting speed. They also need to contain 25 elements to contain
                                ;an endmark
...
screen1         = $0400
        ...
        ; Sprite data
                ...
                ds.b 64,255     ;The sprite frame we are using ($3f)
...
irq2:
irq2_direct:    if SHOW_RASTERTIME>0
                inc $d020
                endif
...
sprxl:          ds.b MAXSPR,0                   ;Unsorted sprite tables to be manipulated by the main program.
sprxh:          ds.b MAXSPR,0                   ;Y & order need to be on the zeropage
sprc:           ds.b MAXSPR,0
sprf:           ds.b MAXSPR,0

sortsprx:       ds.b MAXSPR*2,0                 ;Sorted sprites are doublebuffered
sortsprd010:    ds.b MAXSPR*2,0
sortspry:       ds.b MAXSPR*2,0
sortsprf:       ds.b MAXSPR*2,0
sortsprc:       ds.b MAXSPR*2,0
sprirqline:     ds.b MAXSPR*2,0                 ;Table used to control sprite IRQs

sprirqadvancetbl:
                dc.b -4,-5,-6,-7,-7,-8,-9,-10   ;$d012 advance for raster IRQs based on number of sprites in the same IRQ
...
sprortbl:       dc.b $01,$02,$04,$08,$10,$20,$40,$80 ;Or table for $d010 manipulation, repeated for 2x max sprites (doublebuffer)
...
sprandtbl:      dc.b $fe,$fd,$fb,$f7,$ef,$df,$bf,$7f  ;And table likewise repeated for 2x max sprites
...
sprirqjumptbllo:dc.b <irq2_spr0                 ;Jump table for starting the spriteIRQ at correct sprite
                dc.b <irq2_spr1
                dc.b <irq2_spr2
                dc.b <irq2_spr3
                dc.b <irq2_spr4
...
sprirqjumptblhi:dc.b >irq2_spr0
                dc.b >irq2_spr1
                dc.b >irq2_spr2
                dc.b >irq2_spr3
                dc.b >irq2_spr4
