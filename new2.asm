...
sprite:           .fill  64, 255          //Our sprite. Really complex design :-)

                .pc=$1000
.var IRQ1LINE        = $fc           //This is the place on screen where the sorting
                                //IRQ happens
.var IRQ2LINE        = $2a           //This is where sprite displaying begins...

.var MAXSPR          = 32            //Maximum number of sprites

.var numsprites      = $02           //Number of sprites that the main program wants
                                //to pass to the sprite sorter
.var sprupdateflag   = $03           //Main program must write a nonzero value here
                                //when it wants new sprites to be displayed
.var sortedsprites   = $04           //Number of sorted sprites for the raster
                                //interrupt
.var tempvariable    = $05           //Just a temp variable used by the raster
                                //interrupt
.var sprirqcounter   = $06           //Sprite counter used by the interrupt

.var sortorder       = $10           //Order-table for sorting. Needs as many bytes
.var sortorderlast   = $2f           //as there are sprites.
