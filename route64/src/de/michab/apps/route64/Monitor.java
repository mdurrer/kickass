/* $Id: Monitor.java,v 1.17 2006/05/19 06:13:33 michab66 Exp $
 *
 * Project: Route64
 *
    ...
    Debugger
{
  ...
  private JComboBox _breakpointTypeSelector = null;
   ...
   */
  public Monitor( Cpu6510 cpu )
  {
    super( "ACT_DEBUG", true );
    
    _cpu = cpu;

    _frame = new JFrame("Route 64 - Monitor");
  ...
  private Component makeBreakpointPanel()
  {
    ...
    _breakpointTypeSelector = new JComboBox();
