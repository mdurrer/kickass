/* $Id: Clock.java,v 1.13 2006/01/06 13:03:22 michab66 Exp $
 *
 * Project: Route64
 *
...
public class Clock
{
   ...
   */
  private final ArrayList _clients = new ArrayList();
  ...
  private ClockHandle minimumTime()
  {
    ...
    ClockHandle result = (ClockHandle)_clients.get( cIdx );
    long minimum = result._time;

    for ( int i = cIdx-1 ; i >= 0 ; i-- )
    {
      ClockHandle ccc = (ClockHandle)_clients.get(i);
