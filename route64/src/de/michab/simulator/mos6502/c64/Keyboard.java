/* $Id: Keyboard.java,v 1.18 2010/02/21 16:59:20 michab66 Exp $
 *
 * Project: Route64
 *
    ...
    Bus
{
  ...
  public void keyTyped( KeyEvent k )
  {
    ...
    Long l = _charToBusMap.get( new Character( c ) );
    if ( l == null )
      return;
...
//        break;
  ...
  public void write( byte inputLines )
  {
    ...
    // TODO inversion is temporary disabled until we fixed svn confusion.
    _listener.write( (byte)/*~*/result );
  }



  /**
   * Nobody should actively read from the Bus.  Note that this is an
   * implementation decision.  Currently a write on the Keyboard is pushed
   * onto the registered listener (push on write).  This method should be
   * implemented if we want pull on read behaviour.
   *
   * @see Forwarder#write(byte)
   */
  public byte read()
  {
    _log.severe( "Unexpected Keyboard#read" );
